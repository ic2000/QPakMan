...
#define LE_S16(X)  ((s16_t) LE_U16((uint16_t) (X)))
#define LE_S32(X)  ((s32_t) LE_U32((uint32_t) (X)))
#define BE_S16(X)  ((s16_t) BE_U16((uint16_t) (X)))
#define BE_S32(X)  ((s32_t) BE_U32((uint32_t) (X)))
